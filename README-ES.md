...
Herramienda de acceso remoto para Android

Androrat es una aplicacion cliente servidor desarrollada en java Android para la parte del cliente y Java/Swing para el servidor

> El nombre Androrat es una mezcla entre Android y RAT (Herramienda de acceso remoto)

Ha sido desarrollado en un equipo de 4 integrantes para un proyecto de universidad. Ha sido realizado en un mes. El objetivo de esta aplicación es brindar informacion sobre el sistema android y obtener información del mismo.

# Detalles tecnicos

* La aplicaion android es el cliente para que el servidor reciba la informacion.

-------Traducido hasta esta linea-------
